            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
                        <a class="nav-link" href="about.html">Data Pengguna</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="category.html">Data Pasien</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="testimonial.html">Data Riwayat</a>
                     </li>
                     <li class="nav-item">
         ...
         <div class="container">
            ...
            include('koneksi.php');
             ...
             ?>
               ...
               <div class="container">
               <form id="image-form" method="post" enctype="multipart/form-data" action="upload_image.php">
            <!-- Input untuk mengunggah gambar -->
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="file-upload" name="image" accept="image/*" onchange="previewImage(event)">
                <label class="custom-file-label" for="file-upload">Pilih Gambar</label>
            </div>
            <br><br>
            <!-- Pratinjau gambar -->
            <div id="image-container" style="display: none;">
                <img id="image-preview" src="" alt="Pratinjau Gambar" style="max-width: 100%;">
            </div>
            <br>
            <!-- Tombol untuk memotong gambar -->
            <button type="button" class="btn btn-secondary" id="crop-button" style="display: none;" onclick="cropImage()">Potong</button>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div id="uploaded-image">
                        ...
                        <img src="<?= htmlspecialchars($_GET['image']) ?>" alt="Gambar yang Diunggah" style="max-width: 100%;">
                        <?php endif; ?>
                     </div>
                     </div>
