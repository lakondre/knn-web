            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="riwayat.php">Data Riwayat</a>
                     </li>
                     <li class="nav-item">
        ...
        <div class="container" style="margin-top: 80px">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                    <a href="tambahpasien.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="editpasien.php?id=<?php echo $row['id_pasien']?>" class="btn btn-sm btn-primary edit-button"><i class="fa fa-edit"></i></a>
                        <a href="hapuspasien.php?id=<?php echo $row['id_pasien']?>" class="btn btn-sm btn-danger delete-button" onclick="return confirm('Apakah yakin menghapus data ini?')"><i class="fa fa-trash"></i></a>
                      </td>
                  </tr>
